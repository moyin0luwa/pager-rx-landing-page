export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#0B345A] via-[#113e6a] to-[#15548a] text-white py-10 px-6 font-sans">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">

        {/* Logo & Tagline */}
        <div className="text-center md:text-left">
          <div className="text-2xl font-bold mb-1">
            Pager<span className="text-cyan-400">RX</span>
          </div>
          <p className="text-sm text-cyan-200 max-w-xs">
            Your personal AI assistant simplifying your healthcare journey.
          </p>
        </div>
        ...
        <nav className="flex space-x-6 text-sm font-medium">
          ...
          <a href="#how-it-works" className="hover:text-cyan-300 transition">
            How It Works
          </a>
          <a href="#trust" className="hover:text-cyan-300 transition">
            Why Trust Us
          </a>
        </nav>
        ...
        <div className="text-sm text-cyan-300 hover:text-cyan-400 transition cursor-pointer">
          Contact us: <a href="mailto:admin@pager-rx.me" className="underline">admin@pager-rx.me</a>
        </div>
      ...
      <div className="mt-10 border-t border-cyan-700 pt-6 text-center text-xs text-cyan-300">
        &copy; {new Date().getFullYear()} Pager-RX. All rights reserved.
      </div>
    </footer>
  );
}
